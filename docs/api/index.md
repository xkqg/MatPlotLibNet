...
|---|---|---|
| `MatPlotLibNet` | Core | `Plt`, `FigureBuilder`, `AxesBuilder`, all 83 series types |
...
| `MatPlotLibNet.Mcp` | `MatPlotLibNet.Mcp` | MCP server — an AI agent renders charts over stdio (from 1.15.0) |
