...
{
    /// <summary>Gets the array of event position sets, one array per row.</summary>
    public double[][] Positions { get; }

    /// <summary>Gets or sets the width of each event tick line in pixels.</summary>
    public double LineWidth { get; set; } = 1.0;

    /// <summary>Gets or sets the per-row colors. If <see langword="null"/>, cycle colors are used.</summary>
    public Color[]? Colors { get; set; }

    /// <summary>Gets or sets the length of each tick as a fraction of the row spacing.</summary>
