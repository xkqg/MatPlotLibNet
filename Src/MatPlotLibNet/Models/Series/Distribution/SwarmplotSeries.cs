...
public sealed class SwarmplotSeries : DatasetSeries, IHasColor, IHasAlpha
{
    ...
    /// <summary>Reconstructs a <see cref="SwarmplotSeries"/> from its serialization DTO and adds it to the axes.</summary>
    /// <param name="axes">The target axes the reconstructed series is added to.</param>
    /// <param name="dto">The serialization DTO carrying the series' persisted properties.</param>
    /// <returns>The reconstructed series instance.</returns>
    internal static SwarmplotSeries FromSeriesDto(Axes axes, SeriesDto dto)
    {
