...
public static class DataFrameColumnReader
{
    ...
    /// </summary>
    /// <param name="column">The <see cref="DataFrameColumn"/> whose rows are converted.</param>
    /// <returns>A <see langword="double"/> array of the same length as <paramref name="column"/>.</returns>
    ...
    /// </summary>
    /// <param name="column">The <see cref="DataFrameColumn"/> whose rows are converted.</param>
    /// <returns>A <see langword="string"/> array of the same length as <paramref name="column"/>.</returns>
